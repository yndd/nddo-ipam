...
func initIpamTenantNetworkInstanceTag(p yentry.Handler, opts ...yentry.HandlerOption) yentry.Handler {
	...
	r := &ipamTenantNetworkInstanceTag{e}
...
func (r *ipamTenantNetworkInstanceTag) WithLogging(log logging.Logger) {
	r.Log = log
}

func (r *ipamTenantNetworkInstanceTag) GetKeys(p *gnmi.Path) []string {
