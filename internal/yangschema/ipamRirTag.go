...
func initIpamRirTag(p yentry.Handler, opts ...yentry.HandlerOption) yentry.Handler {
...
func (r *ipamRirTag) WithLogging(log logging.Logger) {
	r.Log = log
}

func (r *ipamRirTag) GetKeys(p *gnmi.Path) []string {
