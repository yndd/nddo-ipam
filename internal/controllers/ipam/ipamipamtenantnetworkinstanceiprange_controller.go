...
func initYangIpamTenantNetworkinstanceIprange(opts ...yresource.Option) yresource.Handler {
	rr := &yresource.Resource{}
	r := &ipamTenantNetworkinstanceIprange{rr}
...
func (r *ipamTenantNetworkinstanceIprange) GetRootPath(mg resource.Managed) []*gnmi.Path {
...
func (r *ipamTenantNetworkinstanceIprange) GetParentDependency(mg resource.Managed) []*leafref.LeafRef {
...
func (c *connectorIpamTenantNetworkinstanceIprange) Connect(ctx context.Context, mg resource.Managed) (managed.ExternalClient, error) {
	...
	return &externalIpamTenantNetworkinstanceIprange{client: cl, targets: tns, log: log, parser: *parser.NewParser(parser.WithLogger(log)), rootSchema: c.rootSchema, y: c.y}, nil
}
